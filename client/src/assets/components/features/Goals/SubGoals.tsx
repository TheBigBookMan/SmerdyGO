        ...
        <div className="flex flex-col gap-2 w-full">
          <ul className="flex gap-1 mt-1 overflow-x-auto max-w-[720px]">
            {subGoalList.map((goal, idx) => (
              <li
                key={`${goal}${idx}`}
                className="flex pr-1 flex-col border-2 rounded-xl h-[240px] w-[200px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-emerald-100 scrollbar-thumb-rounded-xl scrollbar-track-rounded-xl"
              >
                {goal.editMode ? (
